    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          // Align(
          //   alignment: Alignment(-0.381, 0.014),
          //   child: SizedBox(
          //     width: 91.0,
          //     height: 20.0,
          //     child: Text(
          ...
          Align(
            alignment: Alignment(-0.432, 0.198),
            child: SizedBox(
              width: 62.0,
              height: 20.0,
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 152.0, end: 36.0),
            Pin(size: 20.0, middle: 0.648),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Forgotpasswordscreen(),
                ),
              ],
              child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 14.5, start: 49.0),
            Pin(size: 17.5, middle: 0.5978),
            child:
                ...
                children: <Widget>[
                  Container(
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(8.0),
                      border: Border.all(
                          width: 2.0, color: const Color(0xff00295b)),
                    ),
                  ),
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 16.8, start: 47.1),
            Pin(size: 12.1, middle: 0.5069),
            child: Stack(
              children: <Widget>[
                Container(
                  color: const Color(0xffffffff),
...
const String _svg_biallw =
    '<svg viewBox="49.0 429.5 14.5 17.5" ><path transform="translate(46.98, 429.55)" d="M 15.10583686828613 17.46388816833496 L 3.470102548599243 17.46388816833496 C 2.666634321212769 17.46388816833496 2.015999794006348 16.81179809570312 2.015999794006348 16.00760269165039 L 2.015999794006348 8.725444793701172 C 2.015999794006348 7.921247959136963 2.667361974716187 7.268430709838867 3.470102548599243 7.268430709838867 L 4.19715404510498 7.268430709838867 L 4.19715404510498 5.084364891052246 C 4.19715404510498 2.269315242767334 6.476558685302734 -0.01300014182925224 9.287969589233398 -0.01300014182925224 C 12.09937953948975 -0.01300014182925224 14.37878322601318 2.269315242767334 14.37878322601318 5.084364891052246 L 14.37878322601318 7.268430709838867 L 15.1058349609375 7.268430709838867 C 15.90930366516113 7.268430709838867 16.55993843078613 7.920520782470703 16.55993843078613 8.725444793701172 L 16.55993843078613 16.00760269165039 C 16.55993843078613 16.81107139587402 15.90857601165771 17.46388816833496 15.10583686828613 17.46388816833496 Z M 12.19690227508545 5.084364891052246 C 12.19690227508545 3.475973129272461 10.89417743682861 2.171792984008789 9.287969589233398 2.171792984008789 C 7.681760311126709 2.171792984008789 6.379035472869873 3.475973129272461 6.379035472869873 5.084364891052246 L 6.379035472869873 7.268430709838867 L 12.19690227508545 7.268430709838867 L 12.19690227508545 5.084364891052246 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_rcqklp =
    '<svg viewBox="38.0 589.0 338.0 1.0" ><path transform="translate(38.0, 589.0)" d="M 0 0 L 338 0" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
